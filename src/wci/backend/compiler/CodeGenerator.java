...
public class CodeGenerator extends Backend
{
        ...
        throws Exception
    {
        ...
        String temp = Paths.get(objectFilePath).getFileName().toString();
        programClassName = temp.substring(0, temp.indexOf('.'));
    ...
    private void writeProgramHeader() {
        objectFile.println(".class public " + programClassName);
