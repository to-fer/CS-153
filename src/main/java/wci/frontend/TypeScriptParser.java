...
/*if statements*/
  static final public void boolean_op() throws ParseException {/*@bgen(jjtree) boolean_op */
...
//if statement grammar 
  static final public void if_body() throws ParseException {/*@bgen(jjtree) if_body */
...
if (jjtc000) {
  ...
  static final public void if_part() throws ParseException {/*@bgen(jjtree) if_part */
...
if (jjtc000) {
  ...
  static final public void else_part() throws ParseException {/*@bgen(jjtree) else_part */
...
if (jjtc000) {
  ...
  static final public void while_node() throws ParseException {/*@bgen(jjtree) while_node */
...
HashSet syncSet = new HashSet();
  ...
  static final public void Compound_stmt() throws ParseException {/*@bgen(jjtree) Compound_stmt */
...
if (jjtc000) {
  ...
  static final public void println() throws ParseException {/*@bgen(jjtree) println */
...
//------- Function rules begin -------
  static final public 
void PureFunction() throws ParseException {/*@bgen(jjtree) PureFunction */
...
if (jjtc000) {
  ...
  static final public void Function_invocation() throws ParseException {/*@bgen(jjtree) Function_invocation */
...
//------- Function rules end -------
  static final public 
void declaration() throws ParseException {/*@bgen(jjtree) declaration */
...
if (jjtc000) {
  ...
  static final public void IdentifierType() throws ParseException {SymTabEntry someID; ICodeNodeImpl old; SimpleNode id;
    jj_consume_token(IDENTIFIER);
ASTidentifier jjtn001 = new ASTidentifier(JJTIDENTIFIER);
      boolean jjtc001 = true;
      jjtree.openNodeScope(jjtn001);
...
if (jjtc002) {
  ...
  static final public void boolean_node() throws ParseException {/*@bgen(jjtree) boolean_node */
...
//return the token name in string format
  static void processVariableDecl(Token token, SymTabEntry variableId) throws ParseException {variableId.setDefinition(DefinitionImpl.VARIABLE);
    variableId.appendLineNumber(token.beginLine);
  }

  static String handleError(ParseException ex, HashSet syncSet, boolean doPop) throws ParseException {/*@bgen(jjtree) handleError */
